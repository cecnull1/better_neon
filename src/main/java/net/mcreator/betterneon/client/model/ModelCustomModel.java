package net.mcreator.betterneon.client.model;
...
public class ModelCustomModel<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("better_neon", "model_custom_model"), "main");
