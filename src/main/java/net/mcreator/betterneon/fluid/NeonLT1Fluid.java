...
public abstract class NeonLT1Fluid extends ForgeFlowingFluid {
	public static final ForgeFlowingFluid.Properties PROPERTIES = new ForgeFlowingFluid.Properties(BetterNeonModFluids.NEON_LT_1, BetterNeonModFluids.FLOWING_NEON_LT_1,
			FluidAttributes.builder(new ResourceLocation("better_neon:blocks/neon_lt1"), new ResourceLocation("better_neon:blocks/neon_lt1"))
					...
					.density(0).viscosity(-3)

	).explosionResistance(100f).canMultiply()

			.tickRate(1)

			.bucket(BetterNeonModItems.NEON_LT_1_BUCKET).block(() -> (LiquidBlock) BetterNeonModBlocks.NEON_LT_1.get());

	private NeonLT1Fluid() {
		super(PROPERTIES);
	}
	...
	public static class Source extends NeonLT1Fluid {
		public Source() {
			super();
		}
	...
	public static class Flowing extends NeonLT1Fluid {
		public Flowing() {
			super();
		}
