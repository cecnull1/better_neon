...
import net.mcreator.betterneon.world.features.treedecorators.NeonWorldF1FruitDecorator;
...
public class NeonWorldF1Biome {
	public static Biome createBiome() {
		...
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION,
				PlacementUtils.register("better_neon:tree_neon_world_f_1",
						FeatureUtils.register("better_neon:tree_neon_world_f_1", Feature.TREE,
								new TreeConfiguration.TreeConfigurationBuilder(BlockStateProvider.simple(BetterNeonModBlocks.NEON_LOG.get().defaultBlockState()), new MegaJungleTrunkPlacer(7, 2, 19),
										...
										.decorators(ImmutableList.of(
												...
												NeonWorldF1FruitDecorator.INSTANCE))
										.build()),
