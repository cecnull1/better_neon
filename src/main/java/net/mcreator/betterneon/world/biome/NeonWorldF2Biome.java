...
import net.mcreator.betterneon.world.features.treedecorators.NeonWorldF2FruitDecorator;
...
public class NeonWorldF2Biome {
	public static Biome createBiome() {
		...
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION,
				PlacementUtils.register("better_neon:tree_neon_world_f_2",
						FeatureUtils.register("better_neon:tree_neon_world_f_2", Feature.TREE,
								new TreeConfiguration.TreeConfigurationBuilder(BlockStateProvider.simple(BetterNeonModBlocks.NEON_LOG.get().defaultBlockState()), new MegaJungleTrunkPlacer(7, 2, 19),
										...
										.decorators(ImmutableList.of(
												...
												NeonWorldF2FruitDecorator.INSTANCE))
										.build()),
