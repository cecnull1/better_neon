...
public class EChestFeature extends Feature<NoneFeatureConfiguration> {
	public static EChestFeature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new EChestFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("better_neon:e_chest", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("better_neon:e_chest", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		if (!generate_dimensions.contains(context.level().getLevel().dimension()))
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("better_neon", "echest"));
		if (template == null)
			return false;
