...
public class NeonWorldF2FruitDecorator extends CocoaDecorator {
	public static final NeonWorldF2FruitDecorator INSTANCE = new NeonWorldF2FruitDecorator();
	public static com.mojang.serialization.Codec<NeonWorldF2FruitDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("neon_world_f_2_tree_fruit_decorator");
		ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
	}

	public NeonWorldF2FruitDecorator() {
		super(0.2f);
	}
