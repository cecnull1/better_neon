...
import net.mcreator.betterneon.procedures.NaIWuRanChuFaProcedure;
import net.mcreator.betterneon.init.BetterNeonModTabs;
import net.mcreator.betterneon.block.NeonWorldA1PortalBlock;

public class NeonWorldA1Item extends Item {
	public NeonWorldA1Item() {
	...
	public InteractionResult useOn(UseOnContext context) {
		...
		if (!entity.mayUseItemAt(pos, context.getClickedFace(), itemstack)) {
			...
			if (world.isEmptyBlock(pos) && true) {
				NeonWorldA1PortalBlock.portalSpawn(world, pos);
