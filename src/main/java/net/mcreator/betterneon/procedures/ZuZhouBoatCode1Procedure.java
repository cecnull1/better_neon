...
public class ZuZhouBoatCode1Procedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		Entity_2 = (Entity) world.getEntitiesOfClass(Boat.class, AABB.ofSize(new Vec3(x, (y + 1), z), 1, 1, 1), e -> true).stream().sorted(new Object() {
